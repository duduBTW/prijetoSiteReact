    ...
    return(
        <div className="img" data-aos-duration="270" data-aos="fade-up" data-aos-easing="ease-out-cubic" >
            <li style={item} className="center item">
                ...
                <div className="titulo" style={titulo}>{dat.titulo.length < 30 ? dat.titulo : <div>{dat.titulo.substring(0, dat.titulo.length - (dat.titulo.length - 30))}...</div> }</div>
                <div style={{ height: 'auto', width: 270, fontSize: 17}}>R$:{dat.preco}</div>
                </div>
                </Link>
